...
import { Target, Plus, CalendarDays, MoreVertical, Trash2, Rocket } from 'lucide-react';
    ...
    <div className="space-y-6 animate-in-up">
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {metas.map((meta) => {
            const pct = meta.valor_meta > 0 ? Math.min(Math.round((meta.valor_guardado / meta.valor_meta) * 100), 100) : 0;
                ...
                <CardContent className="flex-1 space-y-3">
                  <div>
                    <p className="text-xs text-muted-foreground mb-1.5">
                      {formatCurrency(meta.valor_guardado)} de {formatCurrency(meta.valor_meta)}
                    </p>
